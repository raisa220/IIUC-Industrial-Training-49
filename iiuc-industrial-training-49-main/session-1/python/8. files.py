...
def csv_to_json(csv_file, json_file):
    ...
    with open('product.csv', 'w', newline='') as file:
        ...
        writer.writerow(["Smartphone", 25000, "New"])  
        writer.writerow(["Tablet", 15000, "Refurbished"])  
        writer.writerow(["Laptop", 50000, "Used"])  
...
log_f("This is a new log message.", "logfile_msg.log")
