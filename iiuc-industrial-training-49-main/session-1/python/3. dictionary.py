...
student = {'name': 'Raisa','roll_number': 'C193220','grades': {'Math': 85, 'Science': 90, 'Bangla': 75}}


print("Student information:" ,student.items())


# Adding a new subject and grade
student['grades']['English'] = 80

# Modifying the grade for a subject
student['grades']['Math'] = 90

print("After modifying : " ,student)

remove_value = student.pop('roll_number')
print("After removing roll number: ", student)

# Printing the modified student information
...
for student, av_grade in avg_grades.items():
    print(student, ":", av_grade)
