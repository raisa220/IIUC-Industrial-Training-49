...
bio_data = "Name: Raisa Ahmed, Age: 25, Country: Bangladesh"
...
formatted_string = "Hello my name is {name}. I am {age} years old and I live in {country}.".format(**my_dict)
...
input_string = "hello i am raisa"
result = count_characters(input_string)
print("Character counts from the string : " ,result)
...
text_hash = "Hello #world! This is a #test #string with #hashtags #Python"
hashtags1 = re.findall(r'#\w+', text_hash)
print("All the Hashtags: ", hashtags1)
